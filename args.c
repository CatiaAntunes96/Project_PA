/*
  ...
  gengetopt --file-name=args --no-handle-help 
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -b, --batch=STRING      text file containing file name or path per line",
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* file name.  */
          ...
          break;
        case 'b':	/* text file containing file name or path per line.  */
